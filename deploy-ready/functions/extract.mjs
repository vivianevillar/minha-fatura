...
- Linha com "PAGAMENTO DE FATURA" ou similar pagamento de fatura anterior: IGNORAR COMPLETAMENTE — não incluir em nenhuma lista
- Linhas de seção (Parcelamentos, Despesas, Compra Data Descrição, Valor Total) podem aparecer mescladas com transações reais: extraia apenas a transação (DD/MM em diante)
