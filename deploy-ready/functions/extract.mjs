...
BANCO:Nubank
TITULAR:Viviane Villar
MES:Abril 2026
VENC:06/04/2026
TOTAL:3148.70
===
PORTADOR:Viviane Villar
25/02|Ifd Companhia Brasilei|02/04|311.73|N
27/02|Estorno Ifd Companhia||28.26|S
28/02|Bem Feitinho||339.31|N
05/03|Rfigueira Clinica Medi||350.00|N
06/03|99negocia||42.95|N
06/03|Uber Trip||136.95|N
===
PORTADOR:Augusto (final 5140)
18/02|Estabelecimento|01/03|99.90|N

Regras IMPORTANTES - leia com atencao:
1. Extraia TODAS as transacoes reais da fatura, nao apenas as do exemplo.
2. No Nubank, o portador aparece como "Nome Sobrenome R$ X.XXX,XX" — use so o nome (sem o valor) como PORTADOR.
3. No Itau, o portador aparece como "NOME (final XXXX)" — use exatamente esse texto como PORTADOR.
4. Datas: converter para DD/MM (25 FEV=25/02, 07 MAR=07/03, 06 ABR=06/04, 25 JAN=25/01)
5. Ultima coluna: S=estorno/credito/negativo, N=compra normal
6. Parcela: formato 01/03. No Nubank vem como "Parcela 2/4" na descricao — extraia como 02/04.
7. desc: nome limpo, sem "••••XXXX", sem "- Parcela X/Y", sem "Estorno de", sem aspas
8. val: numero positivo com ponto decimal. Estornos/creditos tem S na ultima coluna.
9. NÃO incluir proximas faturas nem pagamentos/financiamentos recebidos.`;
