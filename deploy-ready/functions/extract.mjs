...
Regras:
- O exemplo acima e so ilustrativo do formato. Extraia TODAS as transacoes reais da fatura.
- Datas: converter para DD/MM (ex: 25 FEV = 25/02, 07 MAR = 07/03, 06 ABR = 06/04)
- Ultima coluna: S=estorno/credito/negativo, N=compra normal
- Parcela: formato 01/03 ou vazio se nao parcelado. Nubank usa "Parcela X/Y" na descricao.
- PORTADOR: nome exato como aparece na fatura (ex: "Viviane Villar", "Augusto (final 5140)")
- NÃO incluir proximas faturas nem pagamentos recebidos
- desc: nome limpo sem numeros de cartao (••••) e sem "Parcela X/Y"
- val: numero com ponto decimal (ex: 311.73)`;
